...
As a starter, I did some exploratory textual analysis. Here I'd like to share how to make a wordcloud. Below are example word clouds of some games. Battlefield V (unfortunately, with excessive negative reviews): 
